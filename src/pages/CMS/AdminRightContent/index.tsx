...
import  "./style.scss";
const values = [
  { fill: "#fca61f", percent: 60 },
  { fill: "#fca61f", percent: 25 },
  { fill: "#BB67FF", percent: 15 },
];
function AdminRightContent() {
    const [value, onChange] = useState(new Date());
  return (
    <div className="right__content w-1/3 pt-6 ml-2 h-screen max-h-screen">
      <h2 className="mb-6 text-primary font-semibold text-xl ml-2">Tổng quan</h2>
      <div className="flex flex-col items-center w-full gap-y-2 px-3">
        <div className="shadow-circle shadow-gray-300 rounded-xl px-3 py-2 w-full items-center flex justify-between gap-x-5">
          <div className="circles flex justify-between gap-x-2 items-center">
            ...
            <div className="name">
              <div className="number font-bold text-lg text-[#535261]">4.221</div>
        ...
        <div className="shadow-circle shadow-gray-300 rounded-xl px-3 py-2 w-full items-center flex justify-between gap-x-5">
          <div className="circles flex justify-between gap-x-2 items-center">
            ...
            <div className="name">
              <div className="number font-bold text-lg text-[#535261]">276</div>
        ...
        <div className="shadow-circle shadow-gray-300 rounded-xl px-3 py-2 w-full  flex justify-between gap-x-5">
          <div className="circles flex justify-between gap-x-2 items-center">
            <div className="cirlce relative h-14 w-14">
              {values.map((item, index) => (
                <CircularProgressbar
