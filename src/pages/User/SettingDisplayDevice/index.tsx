  ...
  return (
    <div className=''>
      ...
      <div className='flex items-center justify-center'>
        <div className='px-8 w-[450px] rounded-2xl shadow-[2px_2px_8px_rgba(232, 239, 244, 0.8)]'>
          <div className='text-center mb-12'>
            <h2 className='text-2xl font-bold text-primary-500 mt-[104px]'>
              Cài đặt thiết bị MHQ_01
            </h2>
          </div>
          <h2 className='text-center font-bold leading-[30px] text-xl mb-[30px]'>
            Thông tin hiển thị
          </h2>
          <div>
            <h3 className='text-base font-bold text-left text-primary-gray-500 mb-4'>
              Số thứ tự vào quầy
            </h3>
            <Select
...
export default SettingDisplayDevice;
